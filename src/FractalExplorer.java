...
public class FractalExplorer {
    ...
    // задание интерфейса.инициализирует графический интерфейс Swing
...
//Данные операции правильно разметят содержимое окна, сделают его видимым
    ...
    // отрисовка и вывод фрактала фрактала в JImageDisplay
...
//класс должен отобразить пиксельные кооринаты щелчка в область фрактала, а затем вызвать
//метод генератора
